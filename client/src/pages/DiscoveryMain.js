  ...
  render() {
    return (
      <Container>
        ...
        <Card as="a" href="/Easy-to-growth-Plants" style={{ margin: "auto" }}>
          ...
          <Card.ImgOverlay>
            <Card.Title className="text-white text-center" style={{ "font-size": "6vw", margin: "10%", fontWeight: "bold" }}>
        ...
        <Card as="a">
          ...
          <Card.ImgOverlay>
            <Card.Title className="text-danger text-center" style={{ "font-size": "8vw", margin: "20%", fontWeight: "bold" }}>
              Decorative Plants
            </Card.Title>
          </Card.ImgOverlay>
        </Card>
        <br />
        <Card as="a" style={{ margin: "auto" }}>
          <Card.Img src="https://i.pinimg.com/originals/71/6a/39/716a39edf1b3de80260b943982628c49.jpg" alt="Rare Plants" />
          <Card.ImgOverlay>
            <Card.Title className="text-info text-center" style={{ "font-size": "8vw", margin: "20%", fontWeight: "bold" }}>
              Rare Plants
            </Card.Title>
          </Card.ImgOverlay>
        </Card>
